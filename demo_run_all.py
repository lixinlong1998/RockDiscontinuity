...
point_path_list = [
    r"D:\Research\20250313_RockFractureSeg\Code\RockDiscontinuity\data\rock_data\Rock_GLS4_part1_localize_0.02m.ply",
...
if __name__ == "__main__":
    for point_path in point_path_list:
        ...
        point_cloud.EstimateNormals(k_neighbor=30, est_normals=False, est_curvature=True)  # 若输入 PLY 已带法向, 可以暂时注释掉本行
